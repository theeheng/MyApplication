 ...
 */
public class SiteAdapter  extends BaseAdapter implements SpinnerAdapter {
    ...
    public SiteAdapter(Context c, List<Site> data){
        this.data = data;
    ...
    public View getView(int position, View recycle, ViewGroup parent) {
        ...
        text.setText(data.get(position).UnitSiteName);
        return text;
    }
